...
const AREAS = [
  { th: "คุ้มครองชีวิต", en: "Life Protection", icon: "life", body: "ดูแลคนข้างหลังให้เดินต่อได้", tone: "blue",
    points: ["ทดแทนรายได้ให้ครอบครัวเมื่อคุณไม่อยู่", "ปิดภาระหนี้ บ้าน รถ ไม่ตกเป็นของคนข้างหลัง", "เป็นทุนการศึกษาและอนาคตของลูก"] },
  { th: "คุ้มครองสุขภาพ", en: "Health Protection", icon: "health", body: "ค่ารักษาไม่ทำลายเงินเก็บ", tone: "teal",
    points: ["ค่ารักษาก้อนใหญ่ ไม่ต้องควักเงินเก็บ", "ครอบคลุมทั้งผู้ป่วยในและผู้ป่วยนอก", "เลือกโรงพยาบาลและการรักษาที่ดีที่สุดได้"] },
  { th: "โรคร้ายแรง", en: "Critical Illness", icon: "critical", body: "เงินก้อนทดแทนช่วงรักษาตัว", tone: "coral",
    points: ["รับเงินก้อนทันทีเมื่อตรวจพบมะเร็ง หัวใจ หลอดเลือดสมอง", "ทดแทนรายได้ที่หายไประหว่างพักรักษาตัว", "เลือกวิธีรักษาที่ดีที่สุดโดยไม่กังวลเรื่องเงิน"] },
  { th: "วางแผนเกษียณ", en: "Retirement", icon: "retirement", body: "มั่นใจว่ามีพอหลังเลิกทำงาน", tone: "green",
    points: ["สร้างรายได้ประจำหลังเลิกทำงาน", "มั่นใจว่าเงินจะพอใช้ไปตลอดชีวิต", "รักษาคุณภาพชีวิตเดิมโดยไม่ต้องพึ่งลูกหลาน"] },
  { th: "วางแผนภาษี", en: "Tax Planning", icon: "tax", body: "ใช้สิทธิลดหย่อนอย่างคุ้มค่า", tone: "gold",
    points: ["ใช้สิทธิลดหย่อนภาษีได้เต็มเพดาน", "เปลี่ยนเงินภาษีให้กลายเป็นความคุ้มครอง", "วางแผนล่วงหน้าทั้งปี ไม่ต้องรีบปลายปี"] },
  { th: "ส่งต่อมรดก", en: "Legacy Planning", icon: "legacy", body: "ส่งต่อความมั่งคั่งอย่างตั้งใจ", tone: "violet",
    points: ["ส่งต่อทรัพย์สินให้คนที่รักอย่างเป็นระบบ", "ลดข้อพิพาทและภาระภาษีของทายาท", "เตรียมสภาพคล่องให้ครอบครัวได้ทันที"] },
  { th: "วางแผนนิติบุคคล", en: "Business Planning", icon: "corporate", body: "ปกป้องธุรกิจ หุ้นส่วน และความต่อเนื่องขององค์กร", tone: "navy",
    points: ["ปกป้องธุรกิจเมื่อขาดบุคคลสำคัญ", "วางแผนความต่อเนื่องและการส่งต่อกิจการ", "คุ้มครองหุ้นส่วนและข้อตกลงทางธุรกิจ"] },
];
...
const TESTIMONIALS = [
  ...
  { quote: "ตอนแรกกลัวจะโดนเชียร์ขายของแพง ๆ แต่กลับได้คำอธิบายว่าความคุ้มครองที่มีอยู่พอตรงไหน ขาดตรงไหน ไม่ต้องซื้อเพิ่มแบบไม่จำเป็น",
    name: "คุณวีรพล ส.", role: "วิศวกร · ระยอง", initial: "ว" },
  { quote: "อธิบายเรื่องประกันสุขภาพให้คุณพ่อคุณแม่ฟังได้เข้าใจง่ายมาก ไม่มีศัพท์ยาก ๆ ทำให้ทั้งบ้านตัดสินใจร่วมกันได้อย่างสบายใจ",
    name: "คุณนภัสสร ก.", role: "พยาบาล · ขอนแก่น", initial: "น" },
];
